...
@section('content')
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-user-crown'></i> Customers <span class='fw-300'></span> <sup
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        Customers <span class="fw-300"><i></i></span>
                    </h2>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#save").click(function(e) {
                ...
                var ajaxurl = "{{ route('admin.customer.store') }}";
                $.ajax({
                    type: "POST",
                    url: ajaxurl,
                    data: formData,
