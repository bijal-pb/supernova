...
@section('content')
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-users'></i> Staff <span class='fw-300'></span> <sup
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        Staff <span class="fw-300"><i></i></span>
                    </h2>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#staff-table').DataTable({
                ...
                language: {
                    searchPlaceholder: "Search By Name & E-mail.."
                },
            });
            ...
            $("#save").click(function(e) {
                ...
                var ajaxurl = "{{ route('admin.staff.store') }}";
                $.ajax({
                    type: "POST",
                    url: ajaxurl,
                    data: formData,
